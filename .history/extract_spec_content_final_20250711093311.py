...
class SpecContentExtractor:
    ...
    def parse_paragraph_content(self, text: str) -> Tuple[Optional[str], Optional[str], str]:
        ...
        # Look for the specific part names: DESCRIPTION, PRODUCTS, EXECUTION
        # Handle formats like: "PART 1 - GENERAL", "1.0 GENERAL", "GENERAL", etc.
        part_names = ["DESCRIPTION", "PRODUCTS", "EXECUTION"]
        
        # Check if the text contains any of the part names
        for part_name in part_names:
            if part_name in text.upper():
                # Extract the part name and any numbering
                # Handle various formats:
                # "PART 1 - GENERAL" -> "1.0 GENERAL"
                # "1.0 GENERAL" -> "1.0 GENERAL" 
                # "GENERAL" -> "1.0 GENERAL"
                # "2.0 PRODUCTS" -> "2.0 PRODUCTS"
    ...
    def extract_content(self, docx_path: str) -> Dict[str, Any]:
        ...
        for para in doc.paragraphs:
            ...
            if level_type == "section":
                ...
                # Create new part with auto-generated number
                part_number = f"{len(self.extracted_data.get('parts', [])) + 1}.0"
                current_part = {
