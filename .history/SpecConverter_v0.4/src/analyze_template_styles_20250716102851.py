...
class TemplateStyleAnalyzer:
    ...
    def extract_style_info(self, style, doc) -> StyleInfo:
        ...
        try:
            ...
            if hasattr(style, 'paragraph_format'):
                ...
                if pf.hanging_indent:
                    style_info.hanging_indent = pf.hanging_indent.pt
            ...
            if hasattr(style, 'font'):
                ...
                if font.color.rgb:
                    style_info.font_color = font.color.rgb
    ...
    def print_style_details(self, style_name: str = None):
    ...
    def _print_single_style(self, name: str, info: StyleInfo):
        ...
        # Paragraph formatting
        if any([info.alignment, info.left_indent, info.right_indent, info.first_line_indent, 
                info.hanging_indent, info.space_before, info.space_after, info.line_spacing]):
            ...
            if info.hanging_indent is not None:
                print(f"    Hanging Indent: {info.hanging_indent}pt")
