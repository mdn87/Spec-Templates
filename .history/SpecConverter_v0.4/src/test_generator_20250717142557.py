...
OUTPUT_PATH   = '../output/210500_Fire_Suppression_RPA_regenerated.docx'
CONTENT_PATH  = '../output/210500 Common Work Results For Fire Suppression NEED TO CHECK WITH ELEC_v3.json'
FONT_NAME = 'Arial'
FONT_SIZE = 10
