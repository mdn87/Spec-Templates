...
if __name__ == "__main__":
    input_file = "Ready for Final Release/26 05 19 Low-voltage Electrical Power Conductors and Cables/word/styles.xml"
    output_file = "Ready for Final Release/26 05 19 Low-voltage Electrical Power Conductors and Cables/word/styles_formatted.xml"
