    ...
    if hasattr(doc.part, '_comments_part') and doc.part._comments_part is not None:
        for c in doc.part._comments_part.comments:
            ...
            try:
                ...
                if hasattr(c, 'author'):
                    comment_data["author"] = str(c.author)
                elif hasattr(c, '_element') and hasattr(c._element, 'get'):
            ...
            try:
                ...
                if hasattr(c, 'date'):
                    ...
                    comment_data["date"] = str(c._element.get('date', ''))
                else:
            ...
            try:
                ...
                if hasattr(c, 'initials'):
                    comment_data["initials"] = str(c.initials)
                elif hasattr(c, '_element') and hasattr(c._element, 'get'):
            ...
            # Debug: Print the comment object structure
            print(f"DEBUG: Comment object attributes: {dir(c)}")
            if hasattr(c, '_element'):
                print(f"DEBUG: Comment element attributes: {dir(c._element)}")
