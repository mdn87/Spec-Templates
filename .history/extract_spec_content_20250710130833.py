    ...
    def validate_numbering_sequence(self, level_type: str, number: str, content: str):
        ...
        if level_type == "part":
            ...
            if not self.current_part_number:
                ...
                expected_subsection = f"{part_num}.{len(self.current_part.get('subsections', [])) + 1:02d}"
            ...
            if not self.current_subsection_number:
                ...
                expected_item = chr(ord('A') + len(self.current_subsection.get('items', [])))
        ...
        for para in doc.paragraphs:
            ...
            if level_type == "part":
                ...
                if current_item:
                    ...
                    # This might be a comment or other content
                    self.add_error("Content Warning", "Unstructured content found", content)
