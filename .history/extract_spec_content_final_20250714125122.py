...
class SpecContentExtractor:
    ...
    def process_enhanced_elements(self, numbered_elements: List[Dict], embedded_elements: List[Dict]) -> List[Dict]:
        ...
        part_elements = [e for e in numbered_elements if e["level_type"] == "part"]
        ...
        for i, part_elem in enumerate(part_elements):
            ...
            # Find subsections for this part (within the part boundaries)
            part_subsections = []
            for elem in numbered_elements:
                if (elem["level_type"] == "subsection" and 
                    elem["number"].startswith(part_number.split('.')[0] + '.') and
